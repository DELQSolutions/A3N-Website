    ...
    <section className="py-20 bg-primary">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-dark mb-4">
            Biztrox are the smart solution for <span className="text-white">your business</span>
          </h2>
